...
class PokemonDataSpider(scrapy.Spider):
    ...
    def parse(self, response):
        for pokemon in response.css('main.main-content.grid-container'):
            ...
            data['type_defenses'] = {}
            data['type_defenses']['normal'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(1)::attr(class)').get()[21:])
            data['type_defenses']['fire'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(2)::attr(class)').get()[21:])
            data['type_defenses']['water'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(3)::attr(class)').get()[21:])
            data['type_defenses']['electric'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(4)::attr(class)').get()[21:])
            data['type_defenses']['grass'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(5)::attr(class)').get()[21:])
            data['type_defenses']['ice'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(6)::attr(class)').get()[21:])
            data['type_defenses']['fighting'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(7)::attr(class)').get()[21:])
            data['type_defenses']['poison'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(8)::attr(class)').get()[21:])
            data['type_defenses']['ground'] = int(pokemon.css('table.type-table-pokedex > tr')[1].css('td:nth-child(9)::attr(class)').get()[21:])
            data['type_defenses']['flying'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(1)::attr(class)').get()[21:])
            data['type_defenses']['psychic'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(2)::attr(class)').get()[21:])
            data['type_defenses']['bug'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(3)::attr(class)').get()[21:])
            data['type_defenses']['rock'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(4)::attr(class)').get()[21:])
            data['type_defenses']['ghost'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(5)::attr(class)').get()[21:])
            data['type_defenses']['dragon'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(6)::attr(class)').get()[21:])
            data['type_defenses']['dark'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(7)::attr(class)').get()[21:])
            data['type_defenses']['steel'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(8)::attr(class)').get()[21:])
            data['type_defenses']['fairy'] = int(pokemon.css('table.type-table-pokedex:nth-child(2) > tr')[1].css('td:nth-child(9)::attr(class)').get()[21:])
            data['moves'] = []
